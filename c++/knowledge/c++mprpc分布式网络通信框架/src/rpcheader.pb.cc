...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ocean_mprpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::ocean_mprpc::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::ocean_mprpc::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::ocean_mprpc::RpcHeader, args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::ocean_mprpc::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::ocean_mprpc::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\013ocean_mprpc\"I\n\tRpcHea"
...
const ::_pbi::DescriptorTable descriptor_table_rpcheader_2eproto = {
    false, false, 113, descriptor_table_protodef_rpcheader_2eproto,
    "rpcheader.proto",
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:ocean_mprpc.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:ocean_mprpc.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:ocean_mprpc.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:ocean_mprpc.RpcHeader)
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:ocean_mprpc.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ocean_mprpc.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ocean_mprpc.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:ocean_mprpc.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:ocean_mprpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::ocean_mprpc::RpcHeader*
Arena::CreateMaybeMessage< ::ocean_mprpc::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ocean_mprpc::RpcHeader >(arena);
}
